# Calibration Page Wireframe (Low Fidelity)
...
- If no current user, show guidance to go to User page first.
- Only show status/latest/list/start regions after current_user_id exists.

...
def write_session_report(session_summary: dict[str, Any], replay_summary: dict[str, Any], report_error: str | None = None, out_dir: str = "reports/sessions") -> str:
    ...
    if is_training:
        lines = [
            ...
            f"- dda_enabled: {val('dda_enabled')}",
            f"- dda_mode: {val('dda_mode')}",
            f"- dda_applied_count: {val('dda_applied_count')}",
            f"- dda_level_up_count: {val('dda_level_up_count')}",
            f"- dda_level_down_count: {val('dda_level_down_count')}",
            f"- dda_blocked_count: {val('dda_blocked_count')}",
            f"- dda_hold_count: {val('dda_hold_count')}",
            f"- dda_final_level: {val('dda_final_level')}",
            f"- dda_decision_summary: {val('dda_decision_summary')}",
            f"- dda_cooldown_block_count: {val('dda_cooldown_block_count')}",
            f"- dda_conflict_hold_count: {val('dda_conflict_hold_count')}",
            f"- dda_low_sqi_block_count: {val('dda_low_sqi_block_count')}",
            f"- difficulty_decision_count: {val('difficulty_decision_count')}",
            f"- difficulty_changed_count: {val('difficulty_changed_count')}",

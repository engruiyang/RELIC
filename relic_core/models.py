...
class StreamState(str, Enum):
    INITIAL_WAITING="INITIAL_WAITING"; ACTIVE="ACTIVE"; PARTIAL_STALE="PARTIAL_STALE"; STREAM_INACTIVE="STREAM_INACTIVE"; BRIDGE_DISCONNECTED="BRIDGE_DISCONNECTED"; BRIDGE_DEAD="BRIDGE_DEAD"; UNKNOWN="UNKNOWN"
...
class RealtimeSnapshot:
    ...
    last_algorithm_msg_age_ms:int|None=None
    layout_type:int|None=None; last_msg:str|None=None; last_algorithm_name:str|None=None
    ...
    def from_dict(cls,d:dict[str,Any])->"RealtimeSnapshot":
        data=dict(d)
        if 'bridge_connected' not in data: data['bridge_connected']=bool(data.get('connected',False))
        if 'bridge_alive' not in data: data['bridge_alive']=bool(data.get('bridge_connected',False))

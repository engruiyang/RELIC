...
_COMMANDS: list[CommandDescriptor] = [
    ...
    CommandDescriptor("calibration.poll","Poll Calibration Progress","calibration","calibration","GUI/native action calibration.poll","calibration.poll","native_ready","native",True,False,False,False,False,False,"safe",{"user_id":"str"},{"status":"str","progress":"object"},["calibration_progress"],"Native calibration progress query used by TASK26 calibration guidance card."),

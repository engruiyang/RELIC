...
def test_minimal_qml_has_control_panel_and_buttons() -> None:
    ...
    for token in [
        ...
        "invokeAction", "controlManifestJson", "Quality / Focus (TASK6)", "Live Input", "gyro_x", "gyro_y", "gyro_z", "attention", "controlStateJson", "last_command", "last_command_result", "last_command_error", "command_count",
    ]:
        assert token in qml
